...
;------------------------------------------------------------
;	../../core/net/linkaddr.c:60: linkaddr_copy(linkaddr_t *dest, const linkaddr_t *src)
;	-----------------------------------------
...
_linkaddr_copy:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/linkaddr.c:62: memcpy(dest, src, LINKADDR_SIZE);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	ar2,@r0
...
;------------------------------------------------------------
;	../../core/net/linkaddr.c:66: linkaddr_cmp(const linkaddr_t *addr1, const linkaddr_t *addr2)
;	-----------------------------------------
...
_linkaddr_cmp:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/linkaddr.c:68: return (memcmp(addr1, addr2, LINKADDR_SIZE) == 0);
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	mov	ar2,@r0
...
;------------------------------------------------------------
;	../../core/net/linkaddr.c:72: linkaddr_set_node_addr(linkaddr_t *t)
;	-----------------------------------------
...
_linkaddr_set_node_addr:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/linkaddr.c:74: linkaddr_copy(&linkaddr_node_addr, t);
	push	ar5
	push	ar6
	push	ar7
