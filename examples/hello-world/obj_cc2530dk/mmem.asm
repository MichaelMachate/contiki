...
;------------------------------------------------------------
;inited                    Allocated with name '_mmem_init_inited_1_44'
;------------------------------------------------------------
;	../../core/lib/mmem.c:154: static int inited = 0;
	mov	dptr,#_mmem_init_inited_1_44
	clr	a
	movx	@dptr,a
	clr	a
	inc	dptr
...
;	../../core/lib/mmem.c:155: if(inited) {
	...
	orl	a,r6
	jz	00102$
;	../../core/lib/mmem.c:156: return;
	sjmp	00103$
00102$:
;	../../core/lib/mmem.c:158: list_init(mmemlist);
	mov	dptr,#_mmemlist
	movx	a,@dptr
	mov	r5,a
	inc	dptr
	...
	lcall	__sdcc_banked_call
;	../../core/lib/mmem.c:159: avail_memory = MMEM_SIZE;
	mov	dptr,#_avail_memory
	clr	a
	movx	@dptr,a
	mov	a,#0x10
