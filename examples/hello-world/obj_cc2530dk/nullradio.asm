...
;------------------------------------------------------------
;	../../core/dev/nullradio.c:31: radio_read(void *buf, unsigned short buf_len)
;	-----------------------------------------
;	 function radio_read
;	-----------------------------------------
_radio_read:
...
;------------------------------------------------------------
;	../../core/dev/nullradio.c:67: get_value(radio_param_t param, radio_value_t *value)
;	-----------------------------------------
;	 function get_value
;	-----------------------------------------
_get_value:
;	../../core/dev/nullradio.c:69: return RADIO_RESULT_NOT_SUPPORTED;
	mov	dpl,#0x01
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
...
;param                     Allocated to registers 
;------------------------------------------------------------
;	../../core/dev/nullradio.c:73: set_value(radio_param_t param, radio_value_t value)
;	-----------------------------------------
;	 function set_value
;	-----------------------------------------
_set_value:
;	../../core/dev/nullradio.c:75: return RADIO_RESULT_NOT_SUPPORTED;
	mov	dpl,#0x01
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
...
;param                     Allocated to registers 
;------------------------------------------------------------
;	../../core/dev/nullradio.c:79: get_object(radio_param_t param, void *dest, size_t size)
;	-----------------------------------------
;	 function get_object
;	-----------------------------------------
_get_object:
;	../../core/dev/nullradio.c:81: return RADIO_RESULT_NOT_SUPPORTED;
	mov	dpl,#0x01
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
...
;param                     Allocated to registers 
;------------------------------------------------------------
;	../../core/dev/nullradio.c:85: set_object(radio_param_t param, const void *src, size_t size)
;	-----------------------------------------
;	 function set_object
;	-----------------------------------------
_set_object:
;	../../core/dev/nullradio.c:87: return RADIO_RESULT_NOT_SUPPORTED;
	mov	dpl,#0x01
	ljmp	__sdcc_banked_ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
