...
;------------------------------------------------------------
;	../../core/net/mac/mac.c:45: mac_call_sent_callback(mac_callback_t sent, void *ptr, int status, int num_tx)
;	-----------------------------------------
...
_mac_call_sent_callback:
	...
	mov	r6,dph
	mov	r7,b
;	../../core/net/mac/mac.c:63: if(sent) {
	mov	a,r5
	orl	a,r6
	jz	00108$
;	../../core/net/mac/mac.c:64: sent(ptr, status, num_tx);
	push	ar7
	push	ar6
	push	ar5
	mov	a,sp
