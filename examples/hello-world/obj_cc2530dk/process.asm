...
_do_event_data_1_77:
	.ds 3
_do_event_receiver_1_77:
	.ds 3
_do_event_p_1_77:
	.ds 3
_process_post_snum_1_90:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;	../../core/sys/process.c:99: process_start(struct process *p, process_data_t data)
;	-----------------------------------------
...
;	../../core/sys/process.c:115: PT_INIT(&p->pt);
	...
	clr	a
	lcall	__gptrput
;	../../core/sys/process.c:120: process_post_synch(p, PROCESS_EVENT_INIT, data);
	mov	a,sp
	add	a,#0xf8
	mov	r0,a
	mov	a,@r0
...
;------------------------------------------------------------
;ev                        Allocated with name '_do_event_ev_1_77'
;data                      Allocated with name '_do_event_data_1_77'
;receiver                  Allocated with name '_do_event_receiver_1_77'
;p                         Allocated with name '_do_event_p_1_77'
;------------------------------------------------------------
...
;	../../core/sys/process.c:267: receiver = events[fevent].p;
	...
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_do_event_receiver_1_77
	mov	a,r3
	movx	@dptr,a
	mov	a,r4
	inc	dptr
...
;p                         Allocated to registers r5 r6 r7 
;snum                      Allocated with name '_process_post_snum_1_90'
;------------------------------------------------------------
...
;	../../core/sys/process.c:346: snum = (process_num_events_t)(fevent + nevents) % PROCESS_CONF_NUMEVENTS;
	...
	anl	a,#0x1F
	mov	r4,a
	mov	dptr,#_process_post_snum_1_90
	movx	@dptr,a
