...
; This file was generated Sat Nov  3 15:44:48 2018
;--------------------------------------------------------
	.module me
...
;------------------------------------------------------------
;	../../core/lib/me.c:58: me_encode(unsigned char c)
;	-----------------------------------------
;	 function me_encode
;	-----------------------------------------
_me_encode:
	...
	ar1 = 0x01
	ar0 = 0x00
;	../../core/lib/me.c:60: return me_encode_tab[c];
	mov	a,dpl
	mov	b,#0x02
	mul	ab
...
;c                         Allocated to registers r7 
;------------------------------------------------------------
;	../../core/lib/me.c:75: me_decode16(unsigned short m)
;	-----------------------------------------
;	 function me_decode16
;	-----------------------------------------
_me_decode16:
	mov	r6,dpl
;	../../core/lib/me.c:79: m1 = m >> 8;
;	../../core/lib/me.c:80: m2 = m & 0xff;
	mov	r5,dph
;	../../core/lib/me.c:82: c = (me_decode_tab[m1] << 4) |
	mov	a,r5
	...
	anl	a,#0xF0
	mov	r7,a
;	../../core/lib/me.c:83: me_decode_tab[m2];
	mov	a,r6
	mov	dptr,#_me_decode_tab
	movc	a,@a+dptr
	mov	r6,a
	orl	ar7,a
;	../../core/lib/me.c:84: return c;
	mov	dpl,r7
	ljmp	__sdcc_banked_ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	../../core/lib/me.c:99: me_decode8(unsigned char m)
;	-----------------------------------------
;	 function me_decode8
;	-----------------------------------------
_me_decode8:
;	../../core/lib/me.c:101: return  me_decode_tab[m];
	mov	a,dpl
	mov	dptr,#_me_decode_tab
	movc	a,@a+dptr
	mov	r7,a
...
;m                         Allocated to registers r7 
;------------------------------------------------------------
;	../../core/lib/me.c:109: me_valid(unsigned char m)
;	-----------------------------------------
;	 function me_valid
;	-----------------------------------------
_me_valid:
;	../../core/lib/me.c:111: return me_valid_tab[m];
	mov	a,dpl
