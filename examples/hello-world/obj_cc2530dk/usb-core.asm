...
; This file was generated Sat Nov  3 15:44:41 2018
;--------------------------------------------------------
	.module usb_core
...
_usb_configuration_value:
	.ds 1
_get_endpoint_status_status_1_101:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;status                    Allocated with name '_get_endpoint_status_status_1_101'
;------------------------------------------------------------
...
;	../../cpu/cc253x/usb/common/usb-core.c:244: status = usb_arch_get_ep_status(usb_setup_buffer.wIndex);
	...
	mov	a,dpl
	mov	b,dph
	mov	dptr,#_get_endpoint_status_status_1_101
	movx	@dptr,a
	mov	a,b
	inc	dptr
	movx	@dptr,a
;	../../cpu/cc253x/usb/common/usb-core.c:245: usb_send_ctrl_response((uint8_t *) & status, sizeof(status));
	mov	r6,#_get_endpoint_status_status_1_101
	mov	r7,#(_get_endpoint_status_status_1_101 >> 8)
	mov	r5,#0x00
	mov	a,#0x02
	push	acc
	clr	a
