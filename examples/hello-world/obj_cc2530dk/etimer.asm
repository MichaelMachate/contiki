...
;	../../core/sys/etimer.c:157: if(timer->p != PROCESS_NONE) {
	...
	ljmp	00105$
00123$:
;	../../core/sys/etimer.c:158: for(t = timerlist; t != NULL; t = t->next) {
	mov	dptr,#_timerlist
	movx	a,@dptr
	mov	r5,a
	inc	dptr
...
00107$:
	...
	dec	sp
	jz	00105$
;	../../core/sys/etimer.c:159: if(t == timer) {
	mov	a,sp
	add	a,#0xfb
	mov	r0,a
	push	ar5
	...
	sjmp	00108$
00126$:
;	../../core/sys/etimer.c:161: timer->p = PROCESS_CURRENT();
	...
	mov	a,r4
	lcall	__gptrput
;	../../core/sys/etimer.c:162: update_time();
	mov	r0,#_update_time
	mov	r1,#(_update_time >> 8)
	mov	r2,#(_update_time >> 16)
	lcall	__sdcc_banked_call
;	../../core/sys/etimer.c:163: return;
	ljmp	00109$
00108$:
;	../../core/sys/etimer.c:158: for(t = timerlist; t != NULL; t = t->next) {
	mov	a,#0x04
